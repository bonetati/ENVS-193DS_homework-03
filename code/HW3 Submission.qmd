...
2a
For my affective visualization I want to combine both art and R. Through learning about different ggplots I want to use the radial plot to look like a flower representing the week. Each size/shape of the petal refers to the amount of stress on average. With this then I hope to overlay pngs onto the radial plot (still in R) to represent the gist of each day. Through this visualization it goes beyong just the correlation between days and stress, but rather looks deeper into factors affecting stress that are common day to day.
